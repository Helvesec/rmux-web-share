...
export class ServerSession {
    ...
    static mlKemEncapsulate(encapsulation_key, randomness) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(encapsulation_key, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(randomness, wasm.__wbindgen_export);
            const len1 = WASM_VECTOR_LEN;
            wasm.serversession_mlKemEncapsulate(retptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
    ...
    constructor(psk, dh, ml_kem_secret, client_hello, server_challenge) {
        try {
            ...
            const ptr4 = passArray8ToWasm0(server_challenge, wasm.__wbindgen_export);
            const len4 = WASM_VECTOR_LEN;
            wasm.serversession_new(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
