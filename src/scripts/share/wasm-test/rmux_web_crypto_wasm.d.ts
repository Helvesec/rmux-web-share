...
export interface InitOutput {
    ...
    readonly serversession_mlKemEncapsulate: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly serversession_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
